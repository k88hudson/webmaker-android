...
/* 0 */
/*!*******************************************!*\
  !*** ./www_src/pages/project/project.jsx ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Cartesian = __webpack_require__(/*! ../../lib/cartesian */ 4);
	
	var Link = __webpack_require__(/*! ../../components/link/link.jsx */ 11);
	
	var _require = __webpack_require__(/*! ../../components/action-menu/action-menu.jsx */ 12);
	
	var Menu = _require.Menu;
	var PrimaryButton = _require.PrimaryButton;
	var SecondaryButton = _require.SecondaryButton;
	
	var api = __webpack_require__(/*! ../../lib/api */ 1);
	...
	var Map = React.createClass({ displayName: "Map",
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    api({ uri: "/users/foo/projects/bar/pages" }, function (err, pages) {
	      _this.cartesian.allCoords = pages.map(function (el) {
	        return el.coords;
	      });
	      _this.setState({
	        elements: pages,
	        camera: _this.cartesian.getFocusTransform({ x: 0, y: 0 }, _this.state.zoom) });
	    });
	  },
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    el.addEventListener("touchmove", function (event) {
	      ...
	      didMove = true;
	      var translateStr = "translate(" + _this.state.camera.x + "px, " + _this.state.camera.y + "px)";
	      var scaleStr = "scale(" + _this.state.zoom + ")";
	      var center;
	      if (event.touches.length > 1) {
	        currentZoom = _this.state.zoom;
	        var dx = event.touches[1].clientX - event.touches[0].clientX;
	        var dy = event.touches[1].clientY - event.touches[0].clientY;
	      ...
	      var x = _this.state.camera.x;
	      var y = _this.state.camera.y;
	    ...
	    el.addEventListener("touchend", function (event) {
	      ...
	      if (event.touches.length === 0) {
	        ...
	        startX = event.touches[0].clientX;
	        startY = event.touches[0].clientY;
	        _this.state.camera.x = currentX;
	        _this.state.camera.y = currentY;
	        _this.state.zoom = currentZoom;
	      }
	    });
	  },
	  selectPage: function selectPage(el) {
	    var _this = this;
	
	    return function () {
	      if (_this.state.selectedEl !== el.id) {
	        _this.setState({
	          camera: _this.cartesian.getFocusTransform(el.coords, _this.state.zoom),
	          selectedEl: el.id
	        });
	      } else {
	        _this.setState({
	  ...
	  addPage: function addPage(coords) {
	    var _this = this;
	    ...
	    return function () {
	      api({ method: "post", uri: "/users/foo/projects/bar/pages", json: {
	        ...
	        _this.cartesian.allCoords.push(coords);
	        _this.setState({
	          elements: update(_this.state.elements, { $push: [newEl] }),
	          camera: _this.cartesian.getFocusTransform(coords, _this.state.zoom),
	          selectedEl: newEl.id
	        });
	      });
	    };
	  ...
	  removePage: function removePage() {
	    ...
	    var index;
	    this.state.elements.forEach(function (el, i) {
	      if (el.id === _this.state.selectedEl) index = i;
	    });
	    if (typeof index === "undefined") {
	      return;
	    }api({ method: "delete", uri: "/users/foo/projects/bar/pages/" + this.state.selectedEl }, function (err) {
	      _this.cartesian.allCoords.splice(index, 1);
	      _this.setState({
	        elements: update(_this.state.elements, { $splice: [[index, 1]] }),
	        zoom: _this.state.zoom >= 1 ? 0.5 : _this.state.zoom,
	        selectedEl: ""
	      });
	    });
	  },
	  render: function render() {
	    ...
	    return React.createElement("div", { id: "map" }, React.createElement("div", { style: { opacity: this.state.elements.length ? 0 : 1 } }, "Loading..."), React.createElement("div", { ref: "bounding", className: "bounding", style: boundingStyle }, React.createElement("div", { className: "test-container", style: containerStyle }, this.state.elements.map(function (el) {
	      var isSelected = el.id === _this.state.selectedEl;
	      return React.createElement("div", { className: classNames({ "page-container": true, selected: isSelected, unselected: _this.state.selectedEl && !isSelected }),
	        style: { backgroundColor: el.style.backgroundColor, transform: _this.cartesian.getTransform(el.coords) },
	        onClick: _this.selectPage(el) });
	    }), this.cartesian.edges.map(function (coords) {
	      return React.createElement("div", { className: "page-container add", style: { transform: _this.cartesian.getTransform(coords) }, onClick: _this.addPage(coords) }, React.createElement("img", { className: "icon", src: "../../img/plus.svg" }));
	    }))), React.createElement(Menu, null, React.createElement(SecondaryButton, { side: "right", off: !this.state.selectedEl, onClick: this.removePage, icon: "../../img/trash.svg" }), React.createElement(PrimaryButton, { url: "/projects/123", off: !this.state.selectedEl, href: "/pages/page", icon: "../../img/pencil.svg" })));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xhr = __webpack_require__(/*! ./api-mock */ 23).getResponse;
	var defaults = __webpack_require__(/*! lodash.defaults */ 30);
	var BASE_URL = "";
	var mocks = __webpack_require__(/*! ./api-mock */ 23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cartesian = (function () {
	  ...
	  _createClass(Cartesian, {
	    ...
	    allX: {
	      get: function () {
	        return this.all.map(function (xy) {
	          return xy.x;
	        });
	      }
	    },
	    ...
	    getAbsDistance: {
	      ...
	      value: function getAbsDistance(xOrY, maxOrMin) {
	        var isX = xOrY === "x";
	    ...
	    getTransform: {
	      ...
	      value: function getTransform(coords) {
	    ...
	    getBoundingSize: {
	      ...
	      value: function getBoundingSize() {
	    ...
	    getFocusTransform: {
	      ...
	      value: function getFocusTransform(coords, zoom) {
	        zoom = zoom || 1;
	    ...
	    getEdges: {
	      ...
	      value: function getEdges() {
	        var result = [];
	        var allStr = this.allCoords.map(function (coords) {
	          return "" + coords.x + "/" + coords.y;
	        });
	        this.allCoords.forEach(function (coords) {
	          var x = coords.x;
	          var y = coords.y;
	
	          var edges = [{ x: x - 1, y: y }, { x: x + 1, y: y }, { x: x, y: y - 1 }, { x: x, y: y + 1 }].map(function (coords) {
	            return "" + coords.x + "/" + coords.y;
	          }).forEach(function (coordString, i) {
...
/* 12 */
/*!********************************************************!*\
  !*** ./www_src/components/action-menu/action-menu.jsx ***!
  \********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = React.createClass({ displayName: "Menu",
	  render: function render() {
	    return React.createElement("div", { className: "action-menu" }, this.props.children);
	  }
	});
	...
	function makeButtonType(type) {
	  return React.createClass({
	    render: function render() {
	      ...
	      var props = assign({}, this.props, { className: className });
	      return React.createElement(Tag, React.__spread({}, props), React.createElement("img", { className: "icon", src: this.props.icon }));
	    }
	  });
	}
...
/* 23 */
/*!*********************************!*\
  !*** ./www_src/lib/api-mock.js ***!
  \*********************************/
/***/ function(module, exports, __webpack_require__) {

	"use strict";
	
	var UrlPattern = __webpack_require__(/*! url-pattern */ 68);
	var assign = __webpack_require__(/*! react/lib/Object.assign */ 19);
	var uuid = __webpack_require__(/*! ./uuid */ 34);
	var pages = __webpack_require__(/*! ./api-fake-data */ 35);
	...
	function pagesAsArray() {
	  var arr = Object.keys(pages).map(function (key) {
	    return pages[key];
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(/*! lodash.assign */ 70),
	    restParam = __webpack_require__(/*! lodash.restparam */ 71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// Generated by CoffeeScript 1.9.2
	"use strict";
	
	(function (root, factory) {
	  if ("function" === "function" && __webpack_require__(/*! !webpack amd options */ 150) != null) {
...
/* 70 */
/*!****************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/index.js ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var baseAssign = __webpack_require__(/*! lodash._baseassign */ 192),
	    createAssigner = __webpack_require__(/*! lodash._createassigner */ 193),
	    isNative = __webpack_require__(/*! lodash.isnative */ 194),
	    keys = __webpack_require__(/*! lodash.keys */ 195);
...
/* 71 */
/*!*******************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.restparam/index.js ***!
  \*******************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 192 */
/*!*************************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash._baseassign/index.js ***!
  \*************************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCopy = __webpack_require__(/*! lodash._basecopy */ 219),
	    isNative = __webpack_require__(/*! lodash.isnative */ 194),
	    keys = __webpack_require__(/*! lodash.keys */ 195);
...
/* 193 */
/*!*****************************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash._createassigner/index.js ***!
  \*****************************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var bindCallback = __webpack_require__(/*! lodash._bindcallback */ 220),
	    isIterateeCall = __webpack_require__(/*! lodash._isiterateecall */ 221),
	    restParam = __webpack_require__(/*! lodash.restparam */ 71);
...
/* 194 */
/*!**********************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash.isnative/index.js ***!
  \**********************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 195 */
/*!******************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash.keys/index.js ***!
  \******************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var isArguments = __webpack_require__(/*! lodash.isarguments */ 222),
	    isArray = __webpack_require__(/*! lodash.isarray */ 223),
	    isNative = __webpack_require__(/*! lodash.isnative */ 194);
...
/* 219 */
/*!********************************************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash._baseassign/~/lodash._basecopy/index.js ***!
  \********************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 220 */
/*!****************************************************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash._createassigner/~/lodash._bindcallback/index.js ***!
  \****************************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 221 */
/*!******************************************************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash._createassigner/~/lodash._isiterateecall/index.js ***!
  \******************************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 222 */
/*!***************************************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash.keys/~/lodash.isarguments/index.js ***!
  \***************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 223 */
/*!***********************************************************************************!*\
  !*** ./~/lodash.defaults/~/lodash.assign/~/lodash.keys/~/lodash.isarray/index.js ***!
  \***********************************************************************************/
/***/ function(module, exports, __webpack_require__) {

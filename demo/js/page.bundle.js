...
/***/ function(module, exports, __webpack_require__) {
	...
	var Positionable = __webpack_require__(/*! ./positionable.jsx */ 8);
	var Generator = __webpack_require__(/*! ./blocks/generator */ 9);
	...
	var Project = React.createClass({ displayName: "Project",
	  ...
	  render: function render() {
	    ...
	    var secondaryClass = function (name) {
	      var names = {
	        secondary: true,
	        active: _this.state.currentElement > -1 && !_this.state.showAddMenu
	      };
	      names[name] = true;
	      return classNames(names);
	    };
	
	    return React.createElement("div", { id: "project", className: "demo" }, React.createElement("div", { className: "pages-container" }, React.createElement("div", { className: "page next top" }), React.createElement("div", { className: "page next right" }), React.createElement("div", { className: "page next bottom" }), React.createElement("div", { className: "page next left" }), React.createElement("div", { className: "page" }, React.createElement("div", { className: "inner" }, React.createElement("div", { ref: "container", className: "positionables" }, positionables)))), React.createElement("div", { className: classNames({ overlay: true, active: this.state.showAddMenu }) }), React.createElement("div", { className: classNames({ controls: true, "add-active": this.state.showAddMenu }) }, React.createElement("div", { className: "add-menu" }, React.createElement("button", { className: "text", onClick: this.addText }, React.createElement("img", { className: "icon", src: "../../img/text.svg" })), React.createElement("button", { className: "image", onClick: this.addImage }, React.createElement("img", { className: "icon", src: "../../img/camera.svg" })), React.createElement("button", { className: "link", onClick: this.addLink }, React.createElement("img", { className: "icon", src: "../../img/link.svg" }))), React.createElement("button", { className: secondaryClass("delete"), onClick: this.deleteElement, active: this.state.currentElement === -1 }, React.createElement("img", { className: "icon", src: "../../img/trash.svg" })), React.createElement("button", { className: "add", onClick: this.toggleAddMenu }), React.createElement(Link, {
	      className: secondaryClass("edit"),
	      url: "/elements/123/" + currentElement + "/" + currentElementType,
	      href: "/pages/element" + "#" + currentElementType }, React.createElement("img", { className: "icon", src: "../../img/brush.svg" }))));
	  },
	  ...
	  formPositionables: function formPositionables(content) {
	    var _this = this;
	
	    return content.map(function (props, i) {
	      if (props === false) {
	        return false;
	      }
	      props.parentWidth = _this.dims.width;
	      props.parentHeight = _this.dims.height;
	      var element = Generator.generateBlock(props);
	      return React.createElement("div", null, React.createElement(Positionable, React.__spread({ ref: "positionable" + i, key: "positionable" + i }, props, { current: _this.state.currentElement === i, onUpdate: _this.updateElement(i) }), element));
	    });
	  },
	
	  appendElement: function appendElement(obj) {
	    this.setState({
	  ...
	  updateElement: function updateElement(index) {
	    return (function (data) {
	      var content = this.state.content;
	      var entry = content[index];
	      Object.keys(data).forEach(function (k) {
	        return entry[k] = data[k];
	      });
	  ...
	  loadFromString: function loadFromString() {
...
/* 8 */
/*!*********************************************!*\
  !*** ./www_src/pages/page/positionable.jsx ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 21);
	var classes = __webpack_require__(/*! classnames */ 20);
	...
	var Positionable = React.createClass({ displayName: "Positionable",
	  ...
	  componentDidMount: function componentDidMount() {
	    if (!this.state.interactive) {
	      return;
	    }var touchHandler = this.touchhandler = __webpack_require__(/*! ./touchhandler */ 26)(this);
	  ...
	  render: function render() {
	    ...
	    var style = {
	      transform: ["translate(" + x + "px, " + y + "px)", "rotate(" + angle + "deg)", "scale(" + scale + ")"].join(" "),
	    ...
	    return React.createElement("div", { className: "positionableContainer", style: mainstyle, key: this.props.key }, React.createElement("div", { ref: "overlay", className: "touchOverlay", hidden: !this.state.touchactive }), React.createElement("div", { style: style, className: className }, this.props.children));
	  },
	
	  handleTranslation: function handleTranslation(x, y) {
	    this.setState({
	      x: x,
	      y: y
	    }, function () {
	  ...
	  handleRotationAndScale: function handleRotationAndScale(angle, scale) {
	    this.setState({
	      angle: angle,
	      scale: scale
	    }, function () {
	  ...
	  handleZIndexChange: function handleZIndexChange(zIndex) {
	    this.setState({
	      zIndex: zIndex
	    });
	  },
	  ...
	  // TODO: stub function while we settle on a schema here
	  setTransform: function setTransform(obj) {
	    this.setState({
	      x: obj.x,
	      y: obj.y,
	      angle: obj.angle,
...
/* 9 */
/*!************************************************!*\
  !*** ./www_src/pages/page/blocks/generator.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 21);
	var Text = __webpack_require__(/*! ./text.jsx */ 27);
	var Link = __webpack_require__(/*! ./link.jsx */ 28);
	var Image = __webpack_require__(/*! ./image.jsx */ 29);
	...
	Generator.generateBlock = function (options) {
	  if (options.type === Generator.TEXT) {
	    return React.createElement(Text, { value: options.value });
	  }
	  if (options.type === Generator.LINK) {
	    return React.createElement(Link, { href: options.href, label: options.label, active: options.active });
	  }
	  if (options.type === Generator.IMAGE) {
	    return React.createElement(Image, { src: options.src, alt: options.alt });
	  }
	  return false;
	};
...
/* 26 */
/*!********************************************!*\
  !*** ./www_src/pages/page/touchhandler.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  function generator(positionable) {
	    ...
	    var handlers = {
	       ...
	       */
	      startmark: function startmark(evt) {
	        evt.preventDefault();
	        evt.stopPropagation();
	       ...
	       */
	      secondFinger: function secondFinger(evt) {
	        evt.preventDefault();
	        evt.stopPropagation();
	       ...
	       */
	      handleTouchRepositioning: function handleTouchRepositioning(evt) {
	        evt.preventDefault();
	        evt.stopPropagation();
	        if (evt.touches.length < 2) {
	          return;
	       ...
	       */
	      endSecondFinger: function endSecondFinger(evt) {
	        evt.preventDefault();
	        evt.stopPropagation();
...
/* 27 */
/*!********************************************!*\
  !*** ./www_src/pages/page/blocks/text.jsx ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = React.createClass({ displayName: "Header",
	  ...
	  render: function render() {
	    return React.createElement("p", null, this.state.value);
	  }
	});
...
/* 28 */
/*!********************************************!*\
  !*** ./www_src/pages/page/blocks/link.jsx ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Link = React.createClass({ displayName: "Link",
	  ...
	  render: function render() {
	    if (this.state.active) {
	      return React.createElement("a", { href: this.state.href }, this.state.label);
	    }return React.createElement("span", { className: "fakelink" }, this.state.label);
	  }
	});
...
/* 29 */
/*!*********************************************!*\
  !*** ./www_src/pages/page/blocks/image.jsx ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = React.createClass({ displayName: "Image",
	  ...
	  render: function render() {
	    return React.createElement("img", { src: this.state.src, alt: this.state.alt });
	  }
	});

...
/* 0 */
/*!*****************************************!*\
  !*** ./www_src/pages/tinker/tinker.jsx ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Tinker = React.createClass({ displayName: "Tinker",
	  mixins: [Binding],
	  ...
	  render: function render() {
	    var tabs = [{
	      menu: React.createElement("img", { className: "icon", src: "../../img/pencil.svg" }),
	      body: React.createElement("div", null, React.createElement("div", { className: "form-group" }, React.createElement(ColorSpectrum, { value: this.state.color, onChange: this.onChangeColor })), React.createElement("div", { className: "form-group" }, React.createElement("label", null, "Transparency"), React.createElement(Range, null)))
	    }, {
	      menu: React.createElement("img", { className: "icon", src: "../../img/settings.svg" }),
	      body: React.createElement("div", null, ["Red", "Green", "Blue"].map(function (color, i) {
	        return React.createElement("div", { className: "form-group" }, React.createElement("label", null, color), React.createElement(Range, { max: 255, unit: "" }));
	      }), React.createElement("div", { className: "form-group" }, React.createElement("label", null, "Transparency"), React.createElement(Range, null)))
	    }];
	    return React.createElement("div", { id: "tinker" }, React.createElement("div", { className: "editor-preview" }, React.createElement("img", { src: "../../img/toucan.svg" })), React.createElement("div", { className: "color-preview" }, React.createElement("code", null, "color: ", this.state.color, ";"), React.createElement("div", { className: "color-preview-right" }, React.createElement("div", { style: { backgroundColor: this.state.color }, className: "color-preview-swatch" }))), React.createElement(Tabs, { className: "editor-options", tabs: tabs }));
	  }
	});
...
/***/ }
/******/ ]);
//# sourceMappingURL=tinker.bundle.js.map